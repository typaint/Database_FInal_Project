...
if (isset($_POST['field_submit'])) {
  ...
  $query = "SELECT * FROM category_view";
...
<!-- Everything inside the BODY tags are visible on page.-->
  <body>
    ...
    <form method="post">
      ...
      <input type="submit" name="field_submit" value="Click to Search all Crime Types">
    </form>
    ...
    <?php
      if (isset($_POST['field_submit'])) {
        ...
        <?php } else { ?>
          ...
          <h3>Sorry, no results found for this Crime Type <?php; ?>. </h3>
        <?php }
    } ?>
